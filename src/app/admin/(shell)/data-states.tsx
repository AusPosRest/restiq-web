...
// shell stays alive around them. Same pattern as /ops's data-states.tsx,
// restyled to the admin realm's status-error token.
...
export function LoadErrorPanel({
  ...
  return (
    <div
      data-testid={testId}
      role="alert"
      className="flex flex-col items-center gap-3 rounded-lg border border-status-error/40 bg-card px-6 py-10 text-center"
    >
      <AlertTriangle className="size-6 text-status-error" aria-hidden="true" />
