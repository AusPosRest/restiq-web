...
const STYLES: Record<string, string> = {
  ...
  awaiting_countersign: "border-status-warning/50 bg-status-warning/10 text-status-warning",
  ...
  overdue: "border-status-warning/50 bg-status-warning/10 text-status-warning",
