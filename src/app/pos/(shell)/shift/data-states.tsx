...
// match content geometry and the inline load-error panel with retry - "no
// toast-only errors for anything that blocks progress". Same shape as
// /admin's data-states.tsx, restyled to the pos realm's status-alert token;
// AD-4's realm-isolation lint rule means it can't be imported across trees.
